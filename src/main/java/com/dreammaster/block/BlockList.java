...
public enum BlockList {
	...
	BloodyNaquadahAlloy(new ModSimpleBaseBlock(new BloodyNaquadahAlloyProperties(), ModTabList.ModBlocksTab)),
	BloodyBlackPlutonium(new ModSimpleBaseBlock(new BloodyBlackPlutoniumProperties(), ModTabList.ModBlocksTab)),
	BloodyCosmicNeutronium(new ModSimpleBaseBlock(new BloodyCosmicNeutroniumProperties(), ModTabList.ModBlocksTab)),
